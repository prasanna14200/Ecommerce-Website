      ...
      <div className=' h-full container mx-auto flex items-center px-4 justify-between'>
            ...
            <div className='flex items-center gap-7'>
                ...
                <div className='hidden md:block'>
                  <Link to='/generate-description' className='px-3 py-1 rounded-full border border-red-600 text-red-600 hover:bg-red-50'>Generate Description</Link>
                </div>

            </div>   {/* closes flex items-center gap-7 */}
